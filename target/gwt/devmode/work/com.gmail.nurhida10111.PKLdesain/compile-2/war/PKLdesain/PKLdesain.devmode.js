...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.PKLdesain=");
    idx += (13 + "PKLdesain".length);  // 
  }
  if (idx >= 0) {
...
//# sourceMappingURL=http://127.0.0.1:9876/sourcemaps/PKLdesain/_sourcemap.json 
//# sourceURL=PKLdesain-0.js
